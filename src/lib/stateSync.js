import { ENTITY_MAP, isWritable, DEVICE_STATISTICS_ENTITY_IDS, LIFETIME_STATISTICS_ENTITY_IDS, STATISTICS_LABELS, EV_CHARGER_MODE_ACTION_STATES, EV_CHARGER_MODE_STATES, EV_CHARGER_SCHEDULE_MODE_STATES, EV_CHARGER_WEEKEND_MODE_STATES, EV_CHARGER_SOLAR_MODE_STATES, EV_CHARGER_PHASE_MODE_STATES, EV_CHARGER_SMART_TOUCH_MODE_STATES, EV_CHARGER_SWIPE_MODE_STATES, EV_CHARGER_STATUS_STATES, EV_CHARGER_OCPP_STATES, USAGE_MODE_STATES, } from "./entities";
...
export function lifetimeStatisticsStatePath(channelPath, entityId) {
...
export function statisticsStatePath(channelPath, entityId) {
...
export async function syncDevices(adapter, devices) {
...
export function parseControlStateId(namespace, stateId) {
