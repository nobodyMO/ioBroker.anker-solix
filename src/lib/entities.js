...
export const EV_CHARGER_MODE_STATES = {
...
export const EV_CHARGER_MODE_ACTION_STATES = {
...
export const EV_CHARGER_SCHEDULE_MODE_STATES = {
    normal: "Normal",
    smart: "Smart",
};
export const EV_CHARGER_WEEKEND_MODE_STATES = {
    same: "Wochenende wie Werktag",
    different: "Wochenende anders",
};
export const EV_CHARGER_SOLAR_MODE_STATES = {
    solar_grid: "Solar & Netz",
    solar_only: "Nur Solar",
};
export const EV_CHARGER_PHASE_MODE_STATES = {
    automatic: "Automatisch",
    one_phase: "1-phasig",
};
export const EV_CHARGER_SMART_TOUCH_MODE_STATES = {
    simple: "Einfach",
    anti_mistouch: "Fehlbedienungsschutz",
};
export const EV_CHARGER_SWIPE_MODE_STATES = {
    off: "Aus",
    start_charge: "Laden starten",
    stop_charge: "Laden stoppen",
    boost_charge: "Boost",
};
export const EV_CHARGER_STATUS_STATES = {
    0: "Standby",
    1: "Vorbereitung",
    2: "Laden",
    3: "Wallbox pausiert",
...
export const EV_CHARGER_OCPP_STATES = {
    0: "Getrennt",
    1: "Verbindet",
    2: "Verbunden",
};
export const PPS_AC_OUTPUT_MODE_STATES = {
    0: "Normal",
    1: "Smart - auto-off below 14W"
};
export const PPS_DC_12V_OUTPUT_MODE_STATES = {
    0: "Normal",
    1: "Smart - auto-off below 3W"
};
export const PPS_DEVICE_TIMEOUT_MINUTES_STATES = {
    0: "Never",
    30: "30 Minuten",
    60: "60 Minuten",
    120: "120 Minuten",
...
export const PPS_DISPLAY_TIMEOUT_SECONDS_STATES = {
    0: "Never",
    10: "10 Sekunden",
    30: "30 Sekunden",
    300: "300 Sekunden",
...
export const PPS_DISPLAY_MODE_STATES = {
    1: "Low",
    2: "Medium",
    3: "High"
};
export const PPS_TEMP_UNIT_FAHRENHEIT_STATES = {
    0: "Celsius",
    1: "Fahrenheit"
};
export const PPS_USB_STATUS_STATES = {
    0: "Inactive",
    1: "Discharging",
    2: "Charging"
};
/** HA de.json labels for preset_usage_mode */
export const USAGE_MODE_STATES = {
...
export const STATISTICS_LABELS = {
    ...
    ...Object.fromEntries(["week", "month", "year"].flatMap(period => {
...
export const DEVICE_STATISTICS_ENTITY_IDS = STATISTICS_ENTITIES.map(e => e.id).filter(id => !LIFETIME_STATISTICS_ENTITY_IDS.includes(id));
export const STATISTICS_ENTITY_IDS = STATISTICS_ENTITIES.map(e => e.id);
export const ENTITY_MAP = new Map([...SENSOR_ENTITIES, ...CONTROL_ENTITIES, ...STATISTICS_ENTITIES].map(e => [e.id, e]));
export function isWritable(entityId, writable) {
