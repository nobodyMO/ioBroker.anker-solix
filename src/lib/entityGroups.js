...
export const ENTITY_ID_GROUPS = {
    ...
    total_energy: [ENTITY_GROUP_SYSTEM_OVERVIEW, ENTITY_GROUP_ENERGY_STATISTICS],
    total_co2_savings: [ENTITY_GROUP_SYSTEM_OVERVIEW, ENTITY_GROUP_ENERGY_STATISTICS],
    total_money_savings: [ENTITY_GROUP_SYSTEM_OVERVIEW, ENTITY_GROUP_ENERGY_STATISTICS],
    ...
    pps_device_sn: [ENTITY_GROUP_PPS],
    pps_input_limit_max: [ENTITY_GROUP_PPS],
    pps_output_timeout_seconds: [ENTITY_GROUP_PPS],
    pps_ac_input_limit: [ENTITY_GROUP_PPS],
    pps_ac_frequency: [ENTITY_GROUP_PPS],
    pps_ac_output_mode: [ENTITY_GROUP_PPS],
    pps_dc_output_timeout_seconds: [ENTITY_GROUP_PPS],
    pps_dc_12v_output_mode: [ENTITY_GROUP_PPS],
    pps_device_timeout_minutes: [ENTITY_GROUP_PPS],
    pps_display_timeout_seconds: [ENTITY_GROUP_PPS],
    pps_display_mode: [ENTITY_GROUP_PPS],
    pps_temp_unit_fahrenheit: [ENTITY_GROUP_PPS],
    pps_temperature: [ENTITY_GROUP_PPS],
    pps_output_power_total: [ENTITY_GROUP_PPS],
    pps_dc_input_power_total: [ENTITY_GROUP_PPS],
    pps_dc_output_power_total: [ENTITY_GROUP_PPS],
    pps_usbc_1_status: [ENTITY_GROUP_PPS],
    pps_usbc_2_status: [ENTITY_GROUP_PPS],
    pps_usbc_3_status: [ENTITY_GROUP_PPS],
    pps_usba_1_status: [ENTITY_GROUP_PPS],
    pps_usbc_1_power: [ENTITY_GROUP_PPS],
    pps_usbc_2_power: [ENTITY_GROUP_PPS],
    pps_usbc_3_power: [ENTITY_GROUP_PPS],
    pps_usba_1_power: [ENTITY_GROUP_PPS],
    ...
    ev_charger_schedule_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_schedule_mode: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_week_start_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_week_end_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_weekend_start_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_weekend_end_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_weekend_mode: [ENTITY_GROUP_EV_CHARGER],
    ...
    ev_charger_load_balance_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_main_breaker_limit: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_load_balance_monitor_device: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_solar_monitor_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_solar_monitor_device: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_plug_status: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_status: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_boost_status: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_bat_charge_power: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_energy: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_voltage_l1: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_voltage_l2: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_voltage_l3: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_current_l1: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_current_l2: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_current_l3: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_power_l1: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_power_l2: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_power_l3: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_energy_l1: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_energy_l2: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_energy_l3: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_plug_countdown_seconds: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_start_countdown_seconds: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_duration_seconds: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_charging_window_seconds: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_ocpp_connect_status: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_cp_signal_status: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_sw_version: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_hw_version: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_restart: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_plug_lock_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_light_brightness: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_light_off_schedule_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_light_off_start_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_light_off_end_time: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_smart_touch_mode: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_modbus_switch: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_wipe_up_mode: [ENTITY_GROUP_EV_CHARGER],
    ev_charger_wipe_down_mode: [ENTITY_GROUP_EV_CHARGER],
    ...
    pps_ac_fast_charge_switch: [ENTITY_GROUP_PPS],
    pps_display_switch: [ENTITY_GROUP_PPS],
    pps_ac_output_power_switch: [ENTITY_GROUP_PPS],
    pps_dc_input_power_switch: [ENTITY_GROUP_PPS],
    pps_port_memory_switch: [ENTITY_GROUP_PPS],
    pps_dc_output_power_switch: [ENTITY_GROUP_PPS],
    // energy statistics
...
export function enabledEntityGroups(config) {
...
export function isEntityEnabled(entityId, config) {
