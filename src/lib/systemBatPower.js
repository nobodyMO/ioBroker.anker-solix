...
export const SYSTEM_BAT_POWER_IDS = ["bat_charge_power", "bat_discharge_power"];
...
export function parseSolarbankBatPowerStateId(namespace, stateId) {
...
export function parsePowerW(val) {
...
export function systemChannelPath(namespace, siteId) {
    return `${namespace}.system.${siteId}`;
}
export async function ensureSystemBatPowerStates(adapter, siteId) {
...
export async function sumSolarbankBatPowerToSystem(adapter, siteId, solarbankSns) {
...
export function buildSiteSolarbankMap(devices) {
    const map = new Map();
...
export async function refreshAllSystemBatPowerSums(adapter, siteSolarbanks) {
...
export async function pruneSolarbankInfoPowerStates(adapter, siteId) {
...
export async function pruneCombinerBatPowerStates(adapter, combinerSn) {
